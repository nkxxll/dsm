...
pub const State = extern struct {
    cjson_ptr: [*c]cJSON = @import("std").mem.zeroes([*c]cJSON),
};
pub const token = extern struct {
    value: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    line: c_int = @import("std").mem.zeroes(c_int),
};
pub export fn get_token_id(arg_token_1: [*c]u8) c_int {
    var token_1 = arg_token_1;
    _ = &token_1;
    if (strcmp(token_1, "DIVIDE") == @as(c_int, 0)) return 4;
    if (strcmp(token_1, "IDENTIFIER") == @as(c_int, 0)) return 12;
    if (strcmp(token_1, "LPAR") == @as(c_int, 0)) return 8;
    if (strcmp(token_1, "RPAR") == @as(c_int, 0)) return 9;
    if (strcmp(token_1, "MINUS") == @as(c_int, 0)) return 2;
    if (strcmp(token_1, "NUMTOKEN") == @as(c_int, 0)) return 10;
    if (strcmp(token_1, "PLUS") == @as(c_int, 0)) return 1;
    if (strcmp(token_1, "POWER") == @as(c_int, 0)) return 5;
    if (strcmp(token_1, "SEMICOLON") == @as(c_int, 0)) return 7;
    if (strcmp(token_1, "STRTOKEN") == @as(c_int, 0)) return 11;
    if (strcmp(token_1, "WRITE") == @as(c_int, 0)) return 6;
    _ = printf("{\"error\" : true, \"message\": \"UNKNOWN TOKEN TYPE %s\"}\n", token_1);
    exit(@as(c_int, 0));
    return 0;
}
pub export fn getValue(arg_token_1: [*c]cJSON) [*c]const u8 {
    var token_1 = arg_token_1;
    _ = &token_1;
    return cJSON_GetObjectItem(token_1, "value").*.valuestring;
}
pub export fn getLine(arg_token_1: [*c]cJSON) [*c]const u8 {
    var token_1 = arg_token_1;
    _ = &token_1;
    return cJSON_GetObjectItem(token_1, "line").*.valuestring;
}
pub export fn unary(arg_fname: [*c]u8, arg_a: [*c]cJSON) [*c]cJSON {
    var fname = arg_fname;
    _ = &fname;
    var a = arg_a;
    _ = &a;
    var res: [*c]cJSON = cJSON_CreateObject();
    _ = &res;
    var arg: [*c]cJSON = cJSON_CreateArray();
    _ = &arg;
    _ = cJSON_AddItemToArray(arg, a);
    _ = cJSON_AddStringToObject(res, "type", fname);
    _ = cJSON_AddItemToObject(res, "arg", arg);
    return res;
}
pub export fn binary(arg_fname: [*c]u8, arg_a: [*c]cJSON, arg_b: [*c]cJSON) [*c]cJSON {
    var fname = arg_fname;
    _ = &fname;
    var a = arg_a;
    _ = &a;
    ...
    _ = &arg;
    _ = cJSON_AddItemToArray(arg, a);
    _ = cJSON_AddItemToArray(arg, b);
    _ = cJSON_AddStringToObject(res, "type", fname);
    _ = cJSON_AddItemToObject(res, "arg", arg);
    return res;
}
pub export fn ternary(arg_fname: [*c]u8, arg_a: [*c]cJSON, arg_b: [*c]cJSON, arg_c: [*c]cJSON) [*c]cJSON {
    var fname = arg_fname;
    _ = &fname;
    var a = arg_a;
    _ = &a;
    ...
    _ = cJSON_AddItemToArray(arg, a);
    _ = cJSON_AddItemToArray(arg, b);
    _ = cJSON_AddItemToArray(arg, c);
    _ = cJSON_AddStringToObject(res, "type", fname);
    _ = cJSON_AddItemToObject(res, "arg", arg);
    return res;
}
pub export var linenumber: [*c]u8 = @import("std").mem.zeroes([*c]u8);
pub export var curtoken: [*c]u8 = @import("std").mem.zeroes([*c]u8);
pub export var curtype: [*c]u8 = @import("std").mem.zeroes([*c]u8);
pub const YYMINORTYPE = extern union {
    yyinit: c_int,
    yy0: [*c]cJSON,
};
pub const yy_action: [33]u8 = [33]u8{
    13,
    6,
    4,
    3,
...
pub const yy_lookahead: [46]u8 = [46]u8{
    16,
    1,
    2,
    3,
...
pub const yy_shift_ofst: [16]u8 = [16]u8{
    33,
    12,
    12,
    12,
...
pub const yy_reduce_ofst: [9]i8 = [9]i8{
    5,
    @as(i8, @bitCast(@as(i8, @truncate(-@as(c_int, 16))))),
    @as(i8, @bitCast(@as(i8, @truncate(-@as(c_int, 6))))),
    9,
    13,
    14,
    15,
...
pub const yy_default: [16]u8 = [16]u8{
    39,
    35,
    35,
    35,
...
pub const struct_yyStackEntry = extern struct {
    stateno: u8 = @import("std").mem.zeroes(u8),
    major: u8 = @import("std").mem.zeroes(u8),
    minor: YYMINORTYPE = @import("std").mem.zeroes(YYMINORTYPE),
};
pub const yyStackEntry = struct_yyStackEntry;
pub const struct_yyParser = extern struct {
    yytos: [*c]yyStackEntry = @import("std").mem.zeroes([*c]yyStackEntry),
    yyerrcnt: c_int = @import("std").mem.zeroes(c_int),
    state: [*c]State = @import("std").mem.zeroes([*c]State),
    yystackEnd: [*c]yyStackEntry = @import("std").mem.zeroes([*c]yyStackEntry),
    yystack: [*c]yyStackEntry = @import("std").mem.zeroes([*c]yyStackEntry),
    yystk0: [100]yyStackEntry = @import("std").mem.zeroes([100]yyStackEntry),
};
pub const yyParser = struct_yyParser;
pub var yyTraceFILE: [*c]FILE = null;
pub var yyTracePrompt: [*c]u8 = null;
pub export fn ParseTrace(arg_TraceFILE: [*c]FILE, arg_zTracePrompt: [*c]u8) void {
    var TraceFILE = arg_TraceFILE;
    _ = &TraceFILE;
    var zTracePrompt = arg_zTracePrompt;
    _ = &zTracePrompt;
...
pub const yyTokenName: [17][*c]const u8 = [17][*c]const u8{
    "$",
    "PLUS",
    "MINUS",
    "TIMES",
...
pub const yyRuleName: [13][*c]const u8 = [13][*c]const u8{
    "code ::= statementblock",
    "statementblock ::=",
...
pub export fn ParseInit(arg_yypRawParser: ?*anyopaque) void {
    var yypRawParser = arg_yypRawParser;
    _ = &yypRawParser;
    var yypParser: [*c]yyParser = @as([*c]yyParser, @ptrCast(@alignCast(yypRawParser)));
    _ = &yypParser;
    yypParser.*.yystack = @as([*c]yyStackEntry, @ptrCast(@alignCast(&yypParser.*.yystk0[@as(usize, @intCast(0))])));
    yypParser.*.yystackEnd = &(blk: {
        const tmp = @as(c_int, 100) - @as(c_int, 1);
        if (tmp >= 0) break :blk yypParser.*.yystack + @as(usize, @intCast(tmp)) else break :blk yypParser.*.yystack - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    yypParser.*.yyerrcnt = -@as(c_int, 1);
    yypParser.*.yytos = yypParser.*.yystack;
    yypParser.*.yystack[@as(c_uint, @intCast(@as(c_int, 0)))].stateno = 0;
    yypParser.*.yystack[@as(c_uint, @intCast(@as(c_int, 0)))].major = 0;
}
pub export fn ParseAlloc(arg_mallocProc: ?*const fn (usize) callconv(.c) ?*anyopaque) ?*anyopaque {
    var mallocProc = arg_mallocProc;
    _ = &mallocProc;
    var yypParser: [*c]yyParser = undefined;
    _ = &yypParser;
    yypParser = @as([*c]yyParser, @ptrCast(@alignCast(mallocProc.?(@as(usize, @bitCast(@sizeOf(yyParser)))))));
    if (yypParser != null) {
        ParseInit(@as(?*anyopaque, @ptrCast(yypParser)));
    }
    return @as(?*anyopaque, @ptrCast(yypParser));
}
pub fn yy_destructor(arg_yypParser: [*c]yyParser, arg_yymajor: u8, arg_yypminor: [*c]YYMINORTYPE) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var yymajor = arg_yymajor;
    _ = &yymajor;
    var yypminor = arg_yypminor;
    _ = &yypminor;
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, yymajor)))) {
            else => break,
        }
        break;
    }
}
pub fn yy_pop_parser_stack(arg_pParser: [*c]yyParser) callconv(.c) void {
    var pParser = arg_pParser;
    _ = &pParser;
    var yytos: [*c]yyStackEntry = undefined;
    _ = &yytos;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(pParser.*.yytos != null))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_pop_parser_stack", "grammar.c", @as(c_int, 566), "pParser->yytos!=0") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(pParser.*.yytos > pParser.*.yystack))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_pop_parser_stack", "grammar.c", @as(c_int, 567), "pParser->yytos > pParser->yystack") else @as(c_int, 0);
    yytos = blk: {
        const ref = &pParser.*.yytos;
        const tmp = ref.*;
        ref.* -= 1;
        break :blk tmp;
    };
    if (yyTraceFILE != null) {
        _ = fprintf(yyTraceFILE, "%sPopping %s\n", yyTracePrompt, yyTokenName[yytos.*.major]);
    }
    yy_destructor(pParser, yytos.*.major, &yytos.*.minor);
}
pub export fn ParseFinalize(arg_p: ?*anyopaque) void {
    var p = arg_p;
    _ = &p;
    var pParser: [*c]yyParser = @as([*c]yyParser, @ptrCast(@alignCast(p)));
    _ = &pParser;
    var yytos: [*c]yyStackEntry = pParser.*.yytos;
    _ = &yytos;
    while (yytos > pParser.*.yystack) {
        if (yyTraceFILE != null) {
            _ = fprintf(yyTraceFILE, "%sPopping %s\n", yyTracePrompt, yyTokenName[yytos.*.major]);
        }
        if (@as(c_int, @bitCast(@as(c_uint, yytos.*.major))) >= @as(c_int, 0)) {
            yy_destructor(pParser, yytos.*.major, &yytos.*.minor);
        }
        yytos -= 1;
    }
}
pub export fn ParseFree(arg_p: ?*anyopaque, arg_freeProc: ?*const fn (?*anyopaque) callconv(.c) void) void {
    var p = arg_p;
    _ = &p;
    var freeProc = arg_freeProc;
    _ = &freeProc;
    if (p == null) return;
    ParseFinalize(p);
    freeProc.?(p);
}
pub fn yy_find_shift_action(arg_iLookAhead: u8, arg_stateno: u8) callconv(.c) u8 {
    var iLookAhead = arg_iLookAhead;
    _ = &iLookAhead;
    var stateno = arg_stateno;
    _ = &stateno;
    var i: c_int = undefined;
    _ = &i;
    if (@as(c_int, @bitCast(@as(c_uint, stateno))) > @as(c_int, 15)) return stateno;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, stateno))) <= @as(c_int, 15)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 686), "stateno <= YY_SHIFT_COUNT") else @as(c_int, 0);
    while (true) {
        i = @as(c_int, @bitCast(@as(c_uint, yy_shift_ofst[stateno])));
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(i >= @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 692), "i>=0") else @as(c_int, 0);
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(i <= @as(c_int, 33)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 693), "i<=YY_ACTTAB_COUNT") else @as(c_int, 0);
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!((i + @as(c_int, 13)) <= @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([46]u8) / @sizeOf(u8)))))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 694), "i+YYNTOKEN<=(int)YY_NLOOKAHEAD") else @as(c_int, 0);
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, iLookAhead))) != @as(c_int, 17)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 695), "iLookAhead!=YYNOCODE") else @as(c_int, 0);
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, iLookAhead))) < @as(c_int, 13)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 696), "iLookAhead < YYNTOKEN") else @as(c_int, 0);
        i += @as(c_int, @bitCast(@as(c_uint, iLookAhead)));
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(i < @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([46]u8) / @sizeOf(u8)))))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 698), "i<(int)YY_NLOOKAHEAD") else @as(c_int, 0);
        if (@as(c_int, @bitCast(@as(c_uint, yy_lookahead[@as(c_uint, @intCast(i))]))) != @as(c_int, @bitCast(@as(c_uint, iLookAhead)))) {
            return yy_default[stateno];
        } else {
            _ = if (__builtin_expect(@as(c_long, @intFromBool(!((i >= @as(c_int, 0)) and (i < @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([33]u8) / @sizeOf(u8))))))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_shift_action", "grammar.c", @as(c_int, 734), "i>=0 && i<(int)(sizeof(yy_action)/sizeof(yy_action[0]))") else @as(c_int, 0);
            return yy_action[@as(c_uint, @intCast(i))];
        }
    }
    return 0;
}
pub fn yy_find_reduce_action(arg_stateno: u8, arg_iLookAhead: u8) callconv(.c) u8 {
    var stateno = arg_stateno;
    _ = &stateno;
    var iLookAhead = arg_iLookAhead;
    _ = &iLookAhead;
    var i: c_int = undefined;
    _ = &i;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, stateno))) <= @as(c_int, 8)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_reduce_action", "grammar.c", @as(c_int, 754), "stateno<=YY_REDUCE_COUNT") else @as(c_int, 0);
    i = @as(c_int, @bitCast(@as(c_int, yy_reduce_ofst[stateno])));
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, iLookAhead))) != @as(c_int, 17)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_reduce_action", "grammar.c", @as(c_int, 757), "iLookAhead!=YYNOCODE") else @as(c_int, 0);
    i += @as(c_int, @bitCast(@as(c_uint, iLookAhead)));
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!((i >= @as(c_int, 0)) and (i < @as(c_int, 33))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_reduce_action", "grammar.c", @as(c_int, 764), "i>=0 && i<YY_ACTTAB_COUNT") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, yy_lookahead[@as(c_uint, @intCast(i))]))) == @as(c_int, @bitCast(@as(c_uint, iLookAhead)))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_find_reduce_action", "grammar.c", @as(c_int, 765), "yy_lookahead[i]==iLookAhead") else @as(c_int, 0);
    return yy_action[@as(c_uint, @intCast(i))];
}
pub fn yyStackOverflow(arg_yypParser: [*c]yyParser) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    if (yyTraceFILE != null) {
        _ = fprintf(yyTraceFILE, "%sStack Overflow!\n", yyTracePrompt);
    }
    while (yypParser.*.yytos > yypParser.*.yystack) {
        yy_pop_parser_stack(yypParser);
    }
    yypParser.*.state = state;
}
pub fn yyTraceShift(arg_yypParser: [*c]yyParser, arg_yyNewState: c_int, arg_zTag: [*c]const u8) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var yyNewState = arg_yyNewState;
    _ = &yyNewState;
    var zTag = arg_zTag;
    _ = &zTag;
    if (yyTraceFILE != null) {
        if (yyNewState < @as(c_int, 16)) {
            _ = fprintf(yyTraceFILE, "%s%s '%s', go to state %d\n", yyTracePrompt, zTag, yyTokenName[yypParser.*.yytos.*.major], yyNewState);
        } else {
            _ = fprintf(yyTraceFILE, "%s%s '%s', pending reduce %d\n", yyTracePrompt, zTag, yyTokenName[yypParser.*.yytos.*.major], yyNewState - @as(c_int, 38));
        }
    }
}
pub fn yy_shift(arg_yypParser: [*c]yyParser, arg_yyNewState: u8, arg_yyMajor: u8, arg_yyMinor: [*c]cJSON) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var yyNewState = arg_yyNewState;
    _ = &yyNewState;
    ...
    if (yytos > yypParser.*.yystackEnd) {
        ...
        yytos = yypParser.*.yytos;
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(yytos <= yypParser.*.yystackEnd))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_shift", "grammar.c", @as(c_int, 836), "yytos <= yypParser->yystackEnd") else @as(c_int, 0);
    }
    if (@as(c_int, @bitCast(@as(c_uint, yyNewState))) > @as(c_int, 15)) {
        yyNewState +%= @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 38) - @as(c_int, 22)))));
    }
    yytos.*.stateno = yyNewState;
    yytos.*.major = yyMajor;
    yytos.*.minor.yy0 = yyMinor;
    yyTraceShift(yypParser, @as(c_int, @bitCast(@as(c_uint, yyNewState))), "Shift");
}
pub const yyRuleInfoLhs: [13]u8 = [13]u8{
    13,
    14,
    14,
    15,
...
pub const yyRuleInfoNRhs: [13]i8 = [13]i8{
...
pub fn yy_accept(arg_yypParser: [*c]yyParser) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    if (yyTraceFILE != null) {
        _ = fprintf(yyTraceFILE, "%sAccept!\n", yyTracePrompt);
    }
    yypParser.*.yyerrcnt = -@as(c_int, 1);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(yypParser.*.yytos == yypParser.*.yystack))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_accept", "grammar.c", @as(c_int, 1115), "yypParser->yytos==yypParser->yystack") else @as(c_int, 0);
    yypParser.*.state = state;
}
pub fn yy_reduce(arg_yypParser: [*c]yyParser, arg_yyruleno: c_uint, arg_yyLookahead: c_int, arg_yyLookaheadToken: [*c]cJSON) callconv(.c) u8 {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var yyruleno = arg_yyruleno;
    _ = &yyruleno;
    var yyLookahead = arg_yyLookahead;
    _ = &yyLookahead;
    var yyLookaheadToken = arg_yyLookaheadToken;
    _ = &yyLookaheadToken;
    var yygoto: c_int = undefined;
    _ = &yygoto;
    var yyact: u8 = undefined;
    _ = &yyact;
    var yymsp: [*c]yyStackEntry = undefined;
    _ = &yymsp;
    var yysize: c_int = undefined;
    _ = &yysize;
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    _ = &yyLookahead;
    ...
    while (true) {
        switch (yyruleno) {
            @as(c_uint, @bitCast(@as(c_int, 0))) => {
                {
                    state.*.cjson_ptr = yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0;
                }
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 1))) => {
                {
                    var res: [*c]cJSON = cJSON_CreateObject();
                    _ = &res;
                    _ = cJSON_AddStringToObject(res, "type", "STATEMENTBLOCK");
                    var arg: [*c]cJSON = cJSON_CreateArray();
                    _ = &arg;
                    _ = cJSON_AddItemToObject(res, "statements", arg);
                    yymsp[@as(c_uint, @intCast(@as(c_int, 1)))].minor.yy0 = res;
                }
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 2))) => {
                {
                    _ = cJSON_AddItemToArray(cJSON_GetObjectItem((blk: {
                        const tmp = -@as(c_int, 1);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, "statements"), yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                    yylhsminor.yy0 = (blk: {
                        const tmp = -@as(c_int, 1);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0;
            ...
            @as(c_uint, @bitCast(@as(c_int, 3))) => {
                {
                    var res: [*c]cJSON = cJSON_CreateObject();
                    _ = &res;
                    _ = cJSON_AddStringToObject(res, "type", "WRITE");
                    _ = cJSON_AddItemToObject(res, "arg", (blk: {
                        const tmp = -@as(c_int, 1);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0);
                    (blk: {
            ...
            @as(c_uint, @bitCast(@as(c_int, 5))) => {
                {
                    var res: [*c]cJSON = cJSON_CreateObject();
                    _ = &res;
                    _ = cJSON_AddStringToObject(res, "type", "NUMBER");
                    _ = cJSON_AddStringToObject(res, "value", getValue(yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0));
                    yylhsminor.yy0 = res;
                }
                yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0 = yylhsminor.yy0;
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 6))) => {
                {
                    var res: [*c]cJSON = cJSON_CreateObject();
                    _ = &res;
                    _ = cJSON_AddStringToObject(res, "type", "STRTOKEN");
                    _ = cJSON_AddStringToObject(res, "value", getValue(yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0));
                    yylhsminor.yy0 = res;
                }
                yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0 = yylhsminor.yy0;
            ...
            @as(c_uint, @bitCast(@as(c_int, 7))) => {
                {
                    var res: [*c]cJSON = cJSON_CreateObject();
                    _ = &res;
                    _ = cJSON_AddStringToObject(res, "type", "VARIABLE");
                    _ = cJSON_AddStringToObject(res, "name", getValue(yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0));
                    _ = cJSON_AddStringToObject(res, "line", getLine(yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0));
                    yylhsminor.yy0 = res;
                }
                yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0 = yylhsminor.yy0;
                break;
            ...
            @as(c_uint, @bitCast(@as(c_int, 8))) => {
                {
                    yylhsminor.yy0 = binary(@as([*c]u8, @ptrCast(@constCast(@volatileCast("PLUS")))), (blk: {
                        const tmp = -@as(c_int, 2);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                }
                (blk: {
                    const tmp = -@as(c_int, 2);
                    if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            ...
            @as(c_uint, @bitCast(@as(c_int, 9))) => {
                {
                    yylhsminor.yy0 = binary(@as([*c]u8, @ptrCast(@constCast(@volatileCast("MINUS")))), (blk: {
                        const tmp = -@as(c_int, 2);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                }
            ...
            @as(c_uint, @bitCast(@as(c_int, 10))) => {
                {
                    yylhsminor.yy0 = binary(@as([*c]u8, @ptrCast(@constCast(@volatileCast("TIMES")))), (blk: {
                        const tmp = -@as(c_int, 2);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                }
            ...
            @as(c_uint, @bitCast(@as(c_int, 11))) => {
                {
                    yylhsminor.yy0 = binary(@as([*c]u8, @ptrCast(@constCast(@volatileCast("DIVIDE")))), (blk: {
                        const tmp = -@as(c_int, 2);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                }
            ...
            @as(c_uint, @bitCast(@as(c_int, 12))) => {
                {
                    yylhsminor.yy0 = binary(@as([*c]u8, @ptrCast(@constCast(@volatileCast("POWER")))), (blk: {
                        const tmp = -@as(c_int, 2);
                        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.minor.yy0, yymsp[@as(c_uint, @intCast(@as(c_int, 0)))].minor.yy0);
                }
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_ulong, @bitCast(@as(c_ulong, yyruleno))) < (@sizeOf([13]u8) / @sizeOf(u8))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_reduce", "grammar.c", @as(c_int, 1033), "yyruleno<sizeof(yyRuleInfoLhs)/sizeof(yyRuleInfoLhs[0])") else @as(c_int, 0);
    yygoto = @as(c_int, @bitCast(@as(c_uint, yyRuleInfoLhs[yyruleno])));
    yysize = @as(c_int, @bitCast(@as(c_int, yyRuleInfoNRhs[yyruleno])));
    yyact = yy_find_reduce_action((blk: {
        const tmp = yysize;
        if (tmp >= 0) break :blk yymsp + @as(usize, @intCast(tmp)) else break :blk yymsp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*.stateno, @as(u8, @bitCast(@as(i8, @truncate(yygoto)))));
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!!((@as(c_int, @bitCast(@as(c_uint, yyact))) > @as(c_int, 15)) and (@as(c_int, @bitCast(@as(c_uint, yyact))) <= @as(c_int, 34))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_reduce", "grammar.c", @as(c_int, 1040), "!(yyact>YY_MAX_SHIFT && yyact<=YY_MAX_SHIFTREDUCE)") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, yyact))) != @as(c_int, 35)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("yy_reduce", "grammar.c", @as(c_int, 1043), "yyact!=YY_ERROR_ACTION") else @as(c_int, 0);
    yymsp += @as(usize, @bitCast(@as(isize, @intCast(yysize + @as(c_int, 1)))));
    yypParser.*.yytos = yymsp;
    yymsp.*.stateno = yyact;
    yymsp.*.major = @as(u8, @bitCast(@as(i8, @truncate(yygoto))));
    yyTraceShift(yypParser, @as(c_int, @bitCast(@as(c_uint, yyact))), "... then shift");
    return yyact;
}
pub fn yy_parse_failed(arg_yypParser: [*c]yyParser) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    if (yyTraceFILE != null) {
        _ = fprintf(yyTraceFILE, "%sFail!\n", yyTracePrompt);
    }
    while (yypParser.*.yytos > yypParser.*.yystack) {
        yy_pop_parser_stack(yypParser);
    }
...
pub fn yy_syntax_error(arg_yypParser: [*c]yyParser, arg_yymajor: c_int, arg_yyminor: [*c]cJSON) callconv(.c) void {
    var yypParser = arg_yypParser;
    _ = &yypParser;
    var yymajor = arg_yymajor;
    _ = &yymajor;
    ...
    var state: [*c]State = yypParser.*.state;
    _ = &state;
    _ = printf("{\"error\" : true, \"message\": \"Syntax Error: Compiler reports unexpected token \\\"%s\\\" of type \\\"%s\\\" in line %s\"}\n", curtoken, curtype, linenumber);
    exit(@as(c_int, 0));
    yypParser.*.state = state;
}
pub export fn Parse(arg_yyp: ?*anyopaque, arg_yymajor: c_int, arg_yyminor: [*c]cJSON, arg_state: [*c]State) void {
    var yyp = arg_yyp;
    _ = &yyp;
    var yymajor = arg_yymajor;
    _ = &yymajor;
    ...
    var yyact: u8 = undefined;
    _ = &yyact;
    var yyendofinput: c_int = undefined;
    _ = &yyendofinput;
    var yypParser: [*c]yyParser = @as([*c]yyParser, @ptrCast(@alignCast(yyp)));
    _ = &yypParser;
    yypParser.*.state = state;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(yypParser.*.yytos != null))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("Parse", "grammar.c", @as(c_int, 1161), "yypParser->yytos!=0") else @as(c_int, 0);
    yyendofinput = @intFromBool(yymajor == @as(c_int, 0));
    yyact = yypParser.*.yytos.*.stateno;
    if (yyTraceFILE != null) {
        if (@as(c_int, @bitCast(@as(c_uint, yyact))) < @as(c_int, 38)) {
            _ = fprintf(yyTraceFILE, "%sInput '%s' in state %d\n", yyTracePrompt, yyTokenName[@as(c_uint, @intCast(yymajor))], @as(c_int, @bitCast(@as(c_uint, yyact))));
        } else {
            _ = fprintf(yyTraceFILE, "%sInput '%s' with pending reduce %d\n", yyTracePrompt, yyTokenName[@as(c_uint, @intCast(yymajor))], @as(c_int, @bitCast(@as(c_uint, yyact))) - @as(c_int, 38));
        }
    }
    while (true) {
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(yypParser.*.yytos >= yypParser.*.yystack))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("Parse", "grammar.c", @as(c_int, 1180), "yypParser->yytos>=yypParser->yystack") else @as(c_int, 0);
        _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, yyact))) == @as(c_int, @bitCast(@as(c_uint, yypParser.*.yytos.*.stateno)))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("Parse", "grammar.c", @as(c_int, 1181), "yyact==yypParser->yytos->stateno") else @as(c_int, 0);
        yyact = yy_find_shift_action(@as(u8, @bitCast(@as(i8, @truncate(yymajor)))), yyact);
        if (@as(c_int, @bitCast(@as(c_uint, yyact))) >= @as(c_int, 38)) {
            var yyruleno: c_uint = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, yyact))) - @as(c_int, 38)));
            _ = &yyruleno;
            _ = if (__builtin_expect(@as(c_long, @intFromBool(!(yyruleno < @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([13][*c]const u8) / @sizeOf([*c]const u8)))))))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("Parse", "grammar.c", @as(c_int, 1186), "yyruleno<(int)(sizeof(yyRuleName)/sizeof(yyRuleName[0]))") else @as(c_int, 0);
            if (yyTraceFILE != null) {
                var yysize: c_int = @as(c_int, @bitCast(@as(c_int, yyRuleInfoNRhs[yyruleno])));
                _ = &yysize;
                if (yysize != 0) {
                    _ = fprintf(yyTraceFILE, "%sReduce %d [%s]%s, pop back to state %d.\n", yyTracePrompt, yyruleno, yyRuleName[yyruleno], if (yyruleno < @as(c_uint, @bitCast(@as(c_int, 13)))) "" else " without external action", @as(c_int, @bitCast(@as(c_uint, (blk: {
                        const tmp = yysize;
                        if (tmp >= 0) break :blk yypParser.*.yytos + @as(usize, @intCast(tmp)) else break :blk yypParser.*.yytos - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.stateno))));
                } else {
                    _ = fprintf(yyTraceFILE, "%sReduce %d [%s]%s.\n", yyTracePrompt, yyruleno, yyRuleName[yyruleno], if (yyruleno < @as(c_uint, @bitCast(@as(c_int, 13)))) "" else " without external action");
                }
            }
            if (@as(c_int, @bitCast(@as(c_int, yyRuleInfoNRhs[yyruleno]))) == @as(c_int, 0)) {
        ...
        } else if (@as(c_int, @bitCast(@as(c_uint, yyact))) <= @as(c_int, 34)) {
            yy_shift(yypParser, yyact, @as(u8, @bitCast(@as(i8, @truncate(yymajor)))), yyminor);
            yypParser.*.yyerrcnt -= 1;
            break;
        } else if (@as(c_int, @bitCast(@as(c_uint, yyact))) == @as(c_int, 36)) {
            yypParser.*.yytos -= 1;
            yy_accept(yypParser);
            return;
        } else {
            _ = if (__builtin_expect(@as(c_long, @intFromBool(!(@as(c_int, @bitCast(@as(c_uint, yyact))) == @as(c_int, 35)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("Parse", "grammar.c", @as(c_int, 1233), "yyact == YY_ERROR_ACTION") else @as(c_int, 0);
            yyminorunion.yy0 = yyminor;
            if (yyTraceFILE != null) {
                _ = fprintf(yyTraceFILE, "%sSyntax Error!\n", yyTracePrompt);
            }
            if (yypParser.*.yyerrcnt <= @as(c_int, 0)) {
                yy_syntax_error(yypParser, yymajor, yyminor);
            }
            yypParser.*.yyerrcnt = 3;
            yy_destructor(yypParser, @as(u8, @bitCast(@as(i8, @truncate(yymajor)))), &yyminorunion);
            if (yyendofinput != 0) {
    ...
    if (yyTraceFILE != null) {
        var i: [*c]yyStackEntry = undefined;
        _ = &i;
        var cDiv: u8 = '[';
        _ = &cDiv;
        _ = fprintf(yyTraceFILE, "%sReturn. Stack=", yyTracePrompt);
        {
            i = &yypParser.*.yystack[@as(c_uint, @intCast(@as(c_int, 1)))];
            while (i <= yypParser.*.yytos) : (i += 1) {
                _ = fprintf(yyTraceFILE, "%c%s", @as(c_int, @bitCast(@as(c_uint, cDiv))), yyTokenName[i.*.major]);
                cDiv = ' ';
            }
        }
        _ = fprintf(yyTraceFILE, "]\n");
    }
    return;
}
pub export fn ParseFallback(arg_iToken: c_int) c_int {
    var iToken = arg_iToken;
    _ = &iToken;
    _ = &iToken;
    return 0;
}
pub export fn create_token(arg_value: [*c]u8, arg_line: c_int) [*c]token {
    var value = arg_value;
    _ = &value;
    var line = arg_line;
    _ = &line;
    var t: [*c]token = @as([*c]token, @ptrCast(@alignCast(malloc(@sizeOf(token)))));
    _ = &t;
    t.*.value = strdup(value);
    t.*.line = line;
    return t;
}
pub export fn parse_to_string(arg_input: [*c]u8) [*c]u8 {
    var input = arg_input;
    _ = &input;
    var root: [*c]cJSON = cJSON_Parse(input);
    _ = &root;
    var state: State = undefined;
    _ = &state;
    if (!(root != null)) {
        _ = printf("JSON invalid\n");
        exit(@as(c_int, 0));
    }
    var pParser: ?*anyopaque = ParseAlloc(&malloc);
    _ = &pParser;
    var num: c_int = cJSON_GetArraySize(root);
    _ = &num;
    {
        var i: c_int = 0;
        _ = &i;
        while (i < num) : (i += 1) {
            var node: [*c]cJSON = cJSON_GetArrayItem(root, i);
            _ = &node;
            var line: [*c]u8 = cJSON_GetArrayItem(node, @as(c_int, 0)).*.valuestring;
            _ = &line;
            var @"type": [*c]u8 = cJSON_GetArrayItem(node, @as(c_int, 1)).*.valuestring;
            _ = &@"type";
            var value: [*c]u8 = cJSON_GetArrayItem(node, @as(c_int, 2)).*.valuestring;
            _ = &value;
            var tok: [*c]cJSON = cJSON_CreateObject();
            _ = &tok;
            _ = cJSON_AddStringToObject(tok, "value", value);
            _ = cJSON_AddStringToObject(tok, "line", line);
            linenumber = line;
            curtoken = value;
            curtype = @"type";
            if (strcmp(@"type", "THE") == @as(c_int, 0)) continue;
            if (strcmp(@"type", "COMMENT") == @as(c_int, 0)) continue;
            if (strcmp(@"type", "MCOMMENT") == @as(c_int, 0)) continue;
            var tokenid: c_int = get_token_id(@"type");
            _ = &tokenid;
            Parse(pParser, tokenid, tok, &state);
        }
    }
    Parse(pParser, @as(c_int, 0), null, &state);
...
pub const CJSON_VERSION_PATCH = @as(c_int, 19);
...
// /opt/homebrew/Cellar/zig/0.15.1/lib/zig/include/__stddef_offsetof.h:16:9
...
// ./cjson.h:296:9
pub const PLUS = @as(c_int, 1);
pub const MINUS = @as(c_int, 2);
pub const TIMES = @as(c_int, 3);
pub const DIVIDE = @as(c_int, 4);
pub const POWER = @as(c_int, 5);
pub const WRITE = @as(c_int, 6);
pub const SEMICOLON = @as(c_int, 7);
pub const LPAR = @as(c_int, 8);
pub const RPAR = @as(c_int, 9);
pub const NUMTOKEN = @as(c_int, 10);
pub const STRTOKEN = @as(c_int, 11);
pub const IDENTIFIER = @as(c_int, 12);
pub const _CDEFS_H_ = "";
...
// grammar.c:39:9
pub const INTERFACE = @as(c_int, 1);
pub const YYCODETYPE = u8;
pub const YYNOCODE = @as(c_int, 17);
pub const YYACTIONTYPE = u8;
pub const ParseTOKENTYPE = @compileError("unable to translate C expr: unexpected token ''");
// grammar.c:144:9
pub const YYSTACKDEPTH = @as(c_int, 100);
pub const ParseARG_SDECL = @compileError("unable to translate macro: undefined identifier `state`");
// grammar.c:152:9
pub const ParseARG_PDECL = @compileError("unable to translate macro: undefined identifier `state`");
// grammar.c:153:9
pub const ParseARG_PARAM = @compileError("unable to translate macro: undefined identifier `state`");
// grammar.c:154:9
pub const ParseARG_FETCH = @compileError("unable to translate macro: undefined identifier `state`");
// grammar.c:155:9
pub const ParseARG_STORE = @compileError("unable to translate macro: undefined identifier `yypParser`");
// grammar.c:156:9
pub const YYREALLOC = realloc;
pub const YYFREE = free;
pub const YYDYNSTACK = @as(c_int, 0);
pub const ParseCTX_SDECL = "";
pub const ParseCTX_PDECL = "";
pub const ParseCTX_PARAM = "";
pub const ParseCTX_FETCH = "";
pub const ParseCTX_STORE = "";
pub const YYNSTATE = @as(c_int, 16);
pub const YYNRULE = @as(c_int, 13);
pub const YYNRULE_WITH_ACTION = @as(c_int, 13);
pub const YYNTOKEN = @as(c_int, 13);
pub const YY_MAX_SHIFT = @as(c_int, 15);
pub const YY_MIN_SHIFTREDUCE = @as(c_int, 22);
pub const YY_MAX_SHIFTREDUCE = @as(c_int, 34);
pub const YY_ERROR_ACTION = @as(c_int, 35);
pub const YY_ACCEPT_ACTION = @as(c_int, 36);
pub const YY_NO_ACTION = @as(c_int, 37);
pub const YY_MIN_REDUCE = @as(c_int, 38);
pub const YY_MAX_REDUCE = @as(c_int, 50);
pub const YY_MIN_DSTRCTR = @as(c_int, 0);
pub const YY_MAX_DSTRCTR = @as(c_int, 0);
pub const YY_NLOOKAHEAD = @compileError("unable to translate C expr: expected ')' instead got '['");
// grammar.c:180:9
pub const yytestcase = @compileError("unable to translate C expr: unexpected token ''");
// grammar.c:191:10
pub const YYGROWABLESTACK = @as(c_int, 0);
pub const YY_ACTTAB_COUNT = @as(c_int, 33);
pub const YY_SHIFT_COUNT = @as(c_int, 15);
pub const YY_SHIFT_MIN = @as(c_int, 0);
pub const YY_SHIFT_MAX = @as(c_int, 23);
pub const YY_REDUCE_COUNT = @as(c_int, 8);
pub const YY_REDUCE_MIN = -@as(c_int, 16);
pub const YY_REDUCE_MAX = @as(c_int, 16);
pub inline fn yyGrowStack(X: anytype) @TypeOf(@as(c_int, 1)) {
    _ = &X;
    return @as(c_int, 1);
}
pub const YYMALLOCARGTYPE = usize;
pub const TOKEN = @compileError("unable to translate macro: undefined identifier `yyminor`");
// grammar.c:1088:9
